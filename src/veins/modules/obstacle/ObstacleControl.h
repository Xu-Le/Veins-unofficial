...
{
public:
    ObstacleControl() : cSimpleModule() {}
    ObstacleControl(unsigned stacksize) : cSimpleModule(stacksize) {}
...
protected:
	struct CacheKey {
		...
		CacheKey(const Coord& senderPos, const Coord& receiverPos) : senderPos(senderPos), receiverPos(receiverPos) {}
