...
void Mac1609_4::handleLowerMsg(cMessage* msg)
{
    ...
    if (strcmp(wsm->getName(), "beacon") == 0) // pass information about received frame to the upper layers
    {
    ...
    DBG_MAC << "Received frame name = " << macPkt->getName()
            ...
            << ", dst = " << macPkt->getDestAddr()
            << ", myAddr = " << myMacAddress << std::endl;
