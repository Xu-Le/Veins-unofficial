...
int WaveShortMessage::getGUID() const
{
    return this->GUID;
}

void WaveShortMessage::setGUID(int GUID)
{
    this->GUID = GUID;
}
...
long WaveShortMessage::getSenderAddress() const
{
    return this->senderAddress;
}

void WaveShortMessage::setSenderAddress(long senderAddress)
{
    this->senderAddress = senderAddress;
}

double WaveShortMessage::getSenderAngle() const
{
    return this->senderAngle;
}

void WaveShortMessage::setSenderAngle(double senderAngle)
{
...
int WaveShortMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='G' && strcmp(fieldName, "GUID")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "securityType")==0) return base+2;
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "psid")==0) return base+7;
    if (fieldName[0]=='w' && strcmp(fieldName, "wsmLength")==0) return base+8;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderAddress")==0) return base+9;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderAngle")==0) return base+10;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPos")==0) return base+11;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderSpeed")==0) return base+12;
...
std::string WaveShortMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getGUID());
        case 2: return long2string(pp->getSecurityType());
        case 3: return long2string(pp->getChannelNumber());
        case 4: return long2string(pp->getDataRate());
        case 5: return long2string(pp->getPriority());
        case 6: return long2string(pp->getSerial());
        case 7: return long2string(pp->getPsid());
        case 8: return long2string(pp->getWsmLength());
        case 9: return long2string(pp->getSenderAddress());
        case 10: return double2string(pp->getSenderAngle());
        case 11: {std::stringstream out; out << pp->getSenderPos(); return out.str();}
        case 12: {std::stringstream out; out << pp->getSenderSpeed(); return out.str();}
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setGUID(string2long(value)); return true;
        case 2: pp->setSecurityType(string2long(value)); return true;
        case 3: pp->setChannelNumber(string2long(value)); return true;
        case 4: pp->setDataRate(string2long(value)); return true;
        case 5: pp->setPriority(string2long(value)); return true;
        case 6: pp->setSerial(string2long(value)); return true;
        case 7: pp->setPsid(string2long(value)); return true;
        case 8: pp->setWsmLength(string2long(value)); return true;
        case 9: pp->setSenderAddress(string2long(value)); return true;
        case 10: pp->setSenderAngle(string2double(value)); return true;
...
void *WaveShortMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    WaveShortMessage *pp = (WaveShortMessage *)object; (void)pp;
    switch (field) {
        case 11: return (void *)(&pp->getSenderPos()); break;
        case 12: return (void *)(&pp->getSenderSpeed()); break;
        default: return nullptr;
    }
}
