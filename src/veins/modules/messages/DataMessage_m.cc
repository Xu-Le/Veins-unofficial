...
DataMessage::DataMessage(const char *name, int kind) : ::WaveShortMessage(name,kind)
{
    this->isLast = false;
    this->receiver = 0;
    this->downloader = 0;
...
DataMessage::DataMessage(const DataMessage& other) : ::WaveShortMessage(other)
{
    copy(other);
}
...
bool DataMessage::getIsLast() const
{
    return this->isLast;
}

void DataMessage::setIsLast(bool isLast)
{
    this->isLast = isLast;
}

int DataMessage::getReceiver() const
{
    return this->receiver;
}

void DataMessage::setReceiver(int receiver)
{
    this->receiver = receiver;
}

int DataMessage::getDownloader() const
{
    return this->downloader;
}

void DataMessage::setDownloader(int downloader)
{
    this->downloader = downloader;
}

int DataMessage::getCurOffset() const
{
    return this->curOffset;
}

void DataMessage::setCurOffset(int curOffset)
{
    this->curOffset = curOffset;
}

int DataMessage::getBytesNum() const
{
    return this->bytesNum;
}

void DataMessage::setBytesNum(int bytesNum)
{
...
DataMessageDescriptor::DataMessageDescriptor() : omnetpp::cClassDescriptor("DataMessage", "WaveShortMessage")
{
...
int DataMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "isLast")==0) return base+0;
    ...
    if (fieldName[0]=='b' && strcmp(fieldName, "bytesNum")==0) return base+4;
...
std::string DataMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    DataMessage *pp = (DataMessage *)object; (void)pp;
    switch (field) {
        case 0: return bool2string(pp->getIsLast());
        ...
        case 4: return long2string(pp->getBytesNum());
        default: return "";
    }
}
...
bool DataMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    DataMessage *pp = (DataMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setIsLast(string2bool(value)); return true;
        ...
        case 4: pp->setBytesNum(string2long(value)); return true;
