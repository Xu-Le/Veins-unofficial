...
BeaconMessage::BeaconMessage(const char *name, int kind) : ::WaveShortMessage(name,kind)
{
}

BeaconMessage::BeaconMessage(const BeaconMessage& other) : ::WaveShortMessage(other)
{
    copy(other);
}
...
{
    this->senderFrom = other.senderFrom;
    this->senderTo = other.senderTo;
}

void BeaconMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::WaveShortMessage::parsimPack(b);
    doParsimPacking(b,this->senderFrom);
    doParsimPacking(b,this->senderTo);
}

void BeaconMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::WaveShortMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->senderFrom);
    doParsimUnpacking(b,this->senderTo);
}

Coord& BeaconMessage::getSenderFrom()
{
    return this->senderFrom;
}

void BeaconMessage::setSenderFrom(const Coord& senderFrom)
{
    this->senderFrom = senderFrom;
}

Coord& BeaconMessage::getSenderTo()
{
    return this->senderTo;
}

void BeaconMessage::setSenderTo(const Coord& senderTo)
{
...
BeaconMessageDescriptor::BeaconMessageDescriptor() : omnetpp::cClassDescriptor("BeaconMessage", "WaveShortMessage")
{
...
int BeaconMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderFrom")==0) return base+0;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderTo")==0) return base+1;
...
std::string BeaconMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    BeaconMessage *pp = (BeaconMessage *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getSenderFrom(); return out.str();}
        case 1: {std::stringstream out; out << pp->getSenderTo(); return out.str();}
        default: return "";
    }
}
...
void *BeaconMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    BeaconMessage *pp = (BeaconMessage *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getSenderFrom()); break;
        case 1: return (void *)(&pp->getSenderTo()); break;
        default: return nullptr;
    }
}
