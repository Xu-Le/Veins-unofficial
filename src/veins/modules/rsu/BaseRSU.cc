...
void BaseRSU::onBeacon(BeaconMessage *beaconMsg)
{
    ...
    if ( vehicles.find(sender) != vehicles.end() ) // update old record
    {
        ...
        vehicleInfo->recvPower = phyDeciderResult->getRecvPower_dBm();
    ...
    else // insert new record
    {
        ...
        EV << "    receiving power is " << phyDeciderResult->getRecvPower_dBm() << std::endl;
        vehicleInfo = new VehicleInfo(phyDeciderResult->getRecvPower_dBm(), beaconMsg->getSenderPos(), beaconMsg->getSenderSpeed(), simTime());
