...
{
public:
	TwoRayInterferenceModel(double dielectricConstant, bool debug) : epsilon_r(dielectricConstant), debug(debug) {}
...
protected:
	...
	public:
		...
		ConstMapping* constClone() const { return new Mapping(*this); }
